...
namespace MachineReservations.Tests.Unit.Entities
{
    ...
    {   // snake case
      ...
      //  < InternalsVisibleTo Include = "ProductionScheduler.Tests.Unit" /> - fajen nie ? 
        ...
        public void given_reservation_for_alredy_existing_date_add_reservation_should_fail()
        {
            ...
            var reservation = new MachineReservation
                (Guid.NewGuid(),
                _weeklyMachineReservation.Id,
                "JohnSzop",
                13, // invalid hour
            ...
            var nextReservation = new MachineReservation
                (Guid.NewGuid(),
                _weeklyMachineReservation.Id,
                "JohnSzop",
                13, // invalid hour
        ...
        #region
        private readonly Machine _weeklyMachineReservation;
        private readonly Date _now;
        public PeriodMachineReservationTest()
        {
            //arrange on ctor lvl
            _now = new Date(new DateTime(2022, 11, 24));
            _weeklyMachineReservation = new Machine(
                Guid.NewGuid(),
